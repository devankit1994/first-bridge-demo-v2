    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          <img src="/modern-business-school-campus-with-students-collab.jpg" alt="Student Life" className="w-full h-full object-cover opacity-40" />
        </div>
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-6 py-32">
          <div className="text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#00ff88]/10 border border-[#00ff88] mb-8">
              <Heart className="h-4 w-4 text-[#00ff88]" />
            ...
            <p className="text-lg md:text-xl text-gray-400 mb-10 max-w-2xl mx-auto leading-relaxed text-pretty">
              Vibrant campus life with diverse activities, clubs, and communities for holistic development.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
                <h3 className="text-xl font-bold text-white mb-4">50+ Clubs</h3>
                <p className="text-gray-400">Cultural and professional clubs</p>
              </div>
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
                <h3 className="text-xl font-bold text-white mb-4">Events</h3>
                <p className="text-gray-400">Annual festivals and competitions</p>
              </div>
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
                <h3 className="text-xl font-bold text-white mb-4">Sports</h3>
                <p className="text-gray-400">State-of-the-art sports facilities</p>
              </div>
            </div>
          </div>
        </div>
