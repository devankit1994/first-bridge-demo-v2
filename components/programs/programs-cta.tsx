  ...
  return (
    <section className="py-24 bg-black">
      <div className="max-w-7xl mx-auto px-6">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary/20 via-gray-900 to-brand-orange/20 border border-white/10 p-12 md:p-16">
          {/* Background pattern */}
          ...
          <div className="relative z-10 text-center max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Button
                variant="outline"
                className="border-2 border-white/20 hover:border-brand-orange text-white hover:text-brand-orange font-bold text-base px-8 py-6 rounded-lg transition-all hover:scale-105 bg-transparent"
              >
            ...
            <div className="mt-12 pt-8 border-t border-white/10">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6 text-sm">
                <a href="mailto:admissions@firstbridge.edu" className="text-primary hover:underline font-semibold">
                ...
                <span className="hidden sm:block text-gray-600">|</span>
                <button className="text-primary hover:underline font-semibold">Schedule Campus Visit</button>
              </div>
            </div>
          </div>
        </div>
